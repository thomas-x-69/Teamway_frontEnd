...
const StatCard = ({ image, title, value, change, color }) => {
  ...
  return (
    <div
      className={`bg-white p-2 sm:p-4 rounded-[1rem] shadow-lg relative overflow-hidden
    ...
    >
      <div className="flex items-center justify-between mb-2 sm:mb-4">
        <div
          className={`${BgColors[color]} rounded-full p-1 w-[2rem] h-[2rem] sm:w-[3rem] sm:h-[3rem]
        ...
        >
          <img
            src={image}
            alt={title}
            className="w-[1.2rem] h-[1.2rem] sm:w-[1.7rem] sm:h-[1.7rem] m-auto mt-[2px] sm:mt-[4px]
                         transition-transform duration-300 ease-in-out
                         group-hover:rotate-12"
          />
        </div>
        <p
          className={`text-[0.6rem] sm:text-xs color-[#000] opacity-70
                         transition-all duration-300 ease-in-out
      ...
      <div>
        <h2
          className={`text-[0.8rem] sm:text-[1.2rem] font-semibold color-[#000] mb-1 sm:mb-4
                        transition-all duration-300 ease-in-out
        ...
        <div className="flex items-baseline justify-between">
          <div className="flex items-baseline">
            <p
              className={`text-xl sm:text-4xl font-bold color-[#000]
                             transition-all duration-300 ease-in-out
                             group-hover:scale-110`}
            >
              {isTimeValue ? (
            ...
            <p
              className={`text-xs sm:text-sm color-[#000] mr-1 self-start mt-[2px] sm:mt-[5px]
                            transition-all duration-300 ease-in-out
...
const CallsStatCards = () => {
  return (
    <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-4 rtl">
      <StatCard
        image={callIncoming}
